...
| | 이 도구 | whispermlx (단독) | Notta (유료) |
|---|---|---|---|
| **전사 정확도** | 높음 | 높음 (hallucination 제외) | 보통 |
| **Hallucination** | 없음 | **한국어 심각** ("Jelly" 반복) | 없음 |
| **화자 분리** | 있음 (짧은 추임새 간혹 흔들림) | 있음 (짧은 추임새 간혹 흔들림) | 있음 (안정적) |
| **고유명사/약어** | 정확 | 정확 | 누락/오인식 많음 |
| **문장 분리** | 한 줄씩 깔끔 | 가끔 뭉침 | 긴 덩어리 |
| **영어** | 강함 | 강함 | 강함 |
| **한국어** | 강함 | 약함 (alignment 문제) | 보통 |
| **비용** | 무료 (로컬) | 무료 (로컬) | 유료 |
